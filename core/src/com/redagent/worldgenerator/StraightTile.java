...
public class StraightTile extends MapTile implements StreetTile {

	public StraightTile(Coord coord, boolean solid, int direction) {
	...
	public boolean doesFitTo(MapTile tile) {
		if (tile.getClass() == StraightTile.class) {
